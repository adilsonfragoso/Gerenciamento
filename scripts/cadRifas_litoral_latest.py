...
def cadastrar_sorteio(driver, edicao_data):
    ...
    esperar_e_clicar(driver, (
        By.XPATH,
        '//*[@id="root"]/div/main/div/div/form/div/div[1]/div[1]/div[3]/div/button[11]',
    ))
    
    # Preencher WhatsApp Group
    whatsapp_group_url = "https://chat.whatsapp.com/FQkOgQZxlv96jNT6MD4uUt"
    logger.info(f"Preenchendo WhatsApp Group: {whatsapp_group_url}")
    
    whatsapp_field = driver.find_element(By.NAME, "support.whatsappGroup")
    whatsapp_field.clear()
    whatsapp_field.send_keys(whatsapp_group_url)
    
    logger.info("=== ABA SUPORTE PREENCHIDA COM SUCESSO ===")
